...
class Config:
    ...
    output_dir: Path = Path(r"D:\code\ResearchPractice\mineral_prediction\output\acawlr_paper_aligned")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Paper-aligned ACAWLR five-fold validation.")
